...
#undef BINARY_OP
  ...
  static std::string unary(CXXOperatorCallExpr *E, std::string if_unary, std::string if_binary) {
    return E->getNumArgs() == 1? if_unary : if_binary;
  }

  static std::string toCname(CXXOperatorCallExpr *E) {
    switch(E->getOperator()) {
      case OO_Plus:
        return unary(E, "Positive", "Plus");
      case OO_Minus:
        return unary(E, "Negative", "Minus");
      case OO_Star:
        return unary(E, "Dereference", "Multiply");
      case OO_Amp:
        return unary(E, "Reference", "BitwiseAnd");
      case OO_PlusPlus:
        return unary(E, "PreIncrement", "PostIncrement");
      case OO_MinusMinus:
        return unary(E, "PreDecrement", "PostDecrement");
      case OO_Slash:
        return "Divide";
      case OO_Percent:
        return "Modulo";
  ...
  bool TraverseCXXOperatorCallExpr(CXXOperatorCallExpr *E) {
    if (cparser())
      return TraverseCXXOperatorCallExpr_c(E);
