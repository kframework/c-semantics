...
struct __anonstruct_ShrPcCommonStatSType_21 {
   long a1 ;
   unsigned long n1 ;
...
typedef struct __anonstruct_ShrPcCommonStatSType_21 ShrPcCommonStatSType;
struct __anonstruct_ShrPcMonStatSType_22 {
...
typedef struct __anonstruct_ShrPcMonStatSType_22 ShrPcMonStatSType;
struct __anonstruct_ShrPcGemStatSType_23 {
   unsigned long c1 ;
   unsigned long c2 ;
   unsigned long c3 ;
   unsigned long c4 ;
...
typedef struct __anonstruct_ShrPcGemStatSType_23 ShrPcGemStatSType;
union ShrPcStatUnion {
   ShrPcMonStatSType monitor ;
   ShrPcGemStatSType gem ;
};
struct __anonstruct_ShrPcStatsSType_24 {
   int processId ;
   int sessionId ;
   ShrPcCommonStatSType cmn ;
   union ShrPcStatUnion u ;
};
typedef struct __anonstruct_ShrPcStatsSType_24 ShrPcStatsSType;
struct __anonstruct_WorkEntrySType_25 {
   unsigned long *p1 ;
   unsigned long *p2 ;
   unsigned long *p3 ;
   unsigned long *p4 ;
...
typedef struct __anonstruct_WorkEntrySType_25 WorkEntrySType;
struct __anonstruct_ShrPcPteSType_26 {
   ShrPcStatsSType stats ;
};
typedef struct __anonstruct_ShrPcPteSType_26 ShrPcPteSType;
unsigned long *Local1  ;
unsigned long *Local2  ;
unsigned long *Local3  ;
unsigned long *RDbf1  ;
