...
/* --- GLOBAL VARIABLES --- */
 volatile int32_t g_3 = 0x3D06CE12L;/* VOLATILE GLOBAL g_3 */
 volatile int32_t *g_2[7][2] = {{&g_3, &g_3}, {&g_3, &g_3}, {&g_3, &g_3}, {&g_3, &g_3}, {&g_3, &g_3}, {&g_3, &g_3}, {&g_3, &g_3}};
int32_t g_6 = 0xCCB03629L;
