...
/* --- GLOBAL VARIABLES --- */
int32_t g_2 = -9L;
int32_t g_8 = 0x51C76D7BL;
int32_t * volatile g_7 = &g_8;/* VOLATILE GLOBAL g_7 */
...
{ /* block id: 0 */
    int16_t l_10 = -1L;
    for (g_2 = 0; (g_2 > 7); g_2 = safe_add_func_uint8_t_u_u(g_2, 1))
    { /* block id: 3 */
lbl_9:
        (*g_7) ^= (+(safe_div_func_uint64_t_u_u(g_2, -2L)));
    }
    if (g_2)
        goto lbl_9;
    return l_10;
